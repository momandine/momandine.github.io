...
2. A great big try/except or automatic reboot clause at the highest application level. This is essentially the equivalent of #1, but we're giving up on everything. The downside is that any bug that makes it to production will cause crashloops, sothis needs to be paired with good logging and reporting.
